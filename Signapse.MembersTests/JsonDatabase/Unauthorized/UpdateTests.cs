...
namespace Signapse.Server.JsonDatabase.Unauthorized
{
    ...
    {
        [TestMethod]
        public async Task Update_Existing_User_Returns_Forbidden()
        {
            // Prepare the DB
        ...
        [TestMethod]
        public async Task Update_Invalid_User_Returns_Forbidden()
        {
        ...
        [TestMethod]
        public async Task Update_Unknown_User_Returns_Forbidden()
        {
